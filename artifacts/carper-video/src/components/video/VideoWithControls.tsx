  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Repetir escena actual: activado' : 'Repetir escena actual: desactivado'}
        aria-label={locked ? 'Repetir escena actual: activado' : 'Repetir escena actual: desactivado'}
        aria-pressed={locked}
      >
...
export default function VideoWithControls() {
  ...
  // Export path: no props, preserves recording markers and clean frame.
