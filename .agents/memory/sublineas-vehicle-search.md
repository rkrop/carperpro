...
- **The table fills over time, like stock** — it's empty until a full sync (rate-limited, minutes) and is topped up by webhooks. Do NOT treat an empty `/subcategories` as a bug.
